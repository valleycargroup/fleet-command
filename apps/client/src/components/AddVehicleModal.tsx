...
<div style={{display:"flex",gap:8,marginTop:12,position:"sticky",bottom:0,background:"#12122A",padding:"10px 0"}}><button style={{...S.btn,flex:1,fontSize:16,padding:"12px",opacity:saving?0.6:1}} disabled={saving} onClick={submit}>{saving?"Adding…":"✓ Add Vehicle"}</button><button style={{...S.sm,padding:"12px 20px"}} disabled={saving} onClick={onClose}>Cancel</button></div>
</div></div>;
}
