...
{(vn.vendorFindings||[]).some((x: any)=>x.approved)&&<div style={{marginTop:4,fontSize:14,color:"#F97316",fontWeight:700}}>+ ${(vn.vendorFindings||[]).filter((x: any)=>x.approved).reduce((s: any,x: any)=>s+(Number(x.price)||0),0).toLocaleString()} approved findings</div>}
